...
6) Give the AI current relevant questions regarding product and troubleshooting to answer by usig perplexity ai model. For getting API keys we need a Perplexity MAX or PRO account.To access free perplexity MAX or Pro account use the oxaam.com. It gives access to free accounts.
